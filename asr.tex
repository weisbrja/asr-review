...
\hyphenation{OpenAI} % TODO: is this correct and how to achieve similar thing for wav2vec 2.0?
...
% TODO: remove later
\begin{textblock*}{\textwidth}(2.5cm,.5cm)
    \color{red}
    \noindent
    \textbf{Questions to my supervisor:}
    \begin{itemize}[noitemsep, topsep=0pt, leftmargin=*]
      \item What are further aspects I should compare the models on (other than existing section headings)?
      \item Where to talk about the common techniques, especially the Transformer architecture? Should I maybe talk about the history of used model architectures (\ldots, DNNs, CNNs, RNNs and then Transformers?)
    \end{itemize}
    \color{black}
\end{textblock*}
...
We conclude by summarizing the insights provided by these models, as well as outlining remaining open questions and ongoing challenges in the field of ASR.
...
\subsection{Comparison of ASR models}\label{sec:comparison_of_models}

Having established both the general role of neural networks and in particular Transformer-based architectures as the core of modern ASR systems, we will now look at two concrete models, illustrating very different paradigms of modern Transformer-based ASR:
...
% TODO; describe whisper's multi-task training: translation, transcription for multiple languages, voice activity detection, speaker diarization, time

% TODO: talk about how alignment is learned

\subsubsection{Fine-Tuning}\label{sec:fine-tuning}
